...
import alcatraz.devicecheck.receipt.ReceiptValidator.Companion.APPLE_RECOMMENDED_MAX_AGE
import alcatraz.devicecheck.util.Extensions.Pkcs7.readAsSignedData
import alcatraz.devicecheck.util.Extensions.Pkcs7.readCertificateChain
...
interface ReceiptValidator {
    ...
    val trustAnchor: TrustAnchor
        get() = APPLE_PUBLIC_ROOT_CA_G3_BUILTIN_TRUST_ANCHOR
    val maxAge: Duration
    val clock: Clock
...
class ReceiptValidatorImpl(
    ...
    private fun verifyPayload(
        ...
        if (receiptPayload.appId.value != appIdentifier) {
